...
class TPRTNetwork(nn.Module):
    """Temporal PhysIR radiative-transfer MLP."""
    ...
    def __init__(self, D=8, W=256, input_ch=3, output_ch=59, t_multires=10, multires=10):
        ...
        self.absorption = nn.Linear(W, 1)
        self.path_length = nn.Linear(W, 1)
        self.scattering = nn.Linear(W, 1)
    ...
    def forward(self, x, t):
        ...
        path_length = self.path_length(h)
        scattering = self.scattering(h)
        return absorption, scattering, path_length
