...
from scene.tprt_model import TPRTModel
from scene.tcr_model import TCRModel
from scene.temporal_response_model import TemporalResponseModel
...
class Scene:
    ...
    def save(self, iteration):
        ...
        if hasattr(self.gaussians, "fit_temporal_physir_probe"):
            self.gaussians.fit_temporal_physir_probe(iteration)
        self.gaussians.save_ply(os.path.join(point_cloud_path, "point_cloud.ply"))
        if hasattr(self.gaussians, "save_temporal_physir_probe"):
            self.gaussians.save_temporal_physir_probe(os.path.join(point_cloud_path, "physir_probe.pt"))
